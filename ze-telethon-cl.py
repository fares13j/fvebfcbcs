...
try:
    ...
    api_id = '25535561'
    api_hash = 'f40dbe709ac3d5b8a18aed1edb9b0d04'
    bot_token = '7195652535:AAFu3gPVVq94y7-sGquP14yqltusknowmGo'
    DEVLOO = '6789046153'
    MAX_ACCOUNTS = int('100')
    user_bot = 'ffdhdjhftrrbot'
    id_bot = int('7195652535')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6789046153))
